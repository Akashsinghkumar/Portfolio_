...
import { Volume2, VolumeX, ArrowUpRight, Plus, Download } from "lucide-react";
    ...
    <section className="relative w-full min-h-screen flex flex-col justify-between pt-28 pb-12 px-6 md:px-12 overflow-hidden bg-[#cdebf7] text-slate-900 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 my-auto text-left">
        ...
        <div className="space-y-6 max-w-4xl">
          ...
          >
            <span className="text-[10px] font-extrabold tracking-widest text-[#d69f10] uppercase">
              Hi, I&apos;m Akash Kumar
            </span>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-white font-semibold max-w-xl leading-relaxed drop-shadow-md">
          ...
          >
            ...
            >
              Contac ME <ArrowUpRight className="w-4 h-4" />
            </a>
